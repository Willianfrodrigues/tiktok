view: conjunto_mesclado2 {
  ...
  dimension: influenciador {
    ...
    sql: CASE
          ...
          WHEN ${ad_name} LIKE '%DAYANE GECHONKE %' THEN 'Dayane Gechonke'
          WHEN ${ad_name} LIKE '%CHEF ALVARO %' THEN 'Chef Alvaro'
          ...
          WHEN ${ad_name} LIKE '%MAYARA %'  OR  ${ad_name} LIKE '%Mayara%' OR  ${ad_name} LIKE '%Skala | Institucional | Awareness | May%' OR  ${ad_name} LIKE '%Skala | Institucional | Consideração | May%' THEN 'Mayara'

           WHEN ${ad_name} LIKE '%KISY NA%'  OR  ${ad_name} LIKE '%Kisy Nascimento%' OR  ${ad_name} LIKE '%Kisy%' THEN 'Kisy Nascimento'
           WHEN ${ad_name} LIKE '%DR ALEX LACERDA%' OR  ${ad_name} LIKE '%Alex Lacerda%' OR  ${ad_name} LIKE '%Dr. Alex%' OR  ${ad_name} LIKE '%Dr-Alex%'  THEN 'Dr. Alex Lacerda'
           ...
           WHEN ${ad_name} LIKE '%FLÁVIA LEAL%' OR ${ad_name} LIKE '%FLAVIA LEAL%' OR ${ad_name} LIKE '%Flavia Leal%' OR ${ad_name} LIKE '%| Flavia |%' THEN 'Flavia Leal'
      ...
      WHEN ${ad_name} LIKE  '%LINDA LIS%' OR ${ad_name} LIKE '%Linda lis%' OR ${ad_name} LIKE '%Linda Lis%' OR ${ad_name} LIKE '%Linda Lins%' THEN 'Linda lis'
      ...
      WHEN ${ad_name} LIKE '%MARIA EUGENIA%' OR  ${ad_name} LIKE '%MARIA EUGÊNIA%' THEN 'Maria Eugenia'
      ...
      WHEN ${ad_name} LIKE '%EDUARDA MELO %' OR  ${ad_name} LIKE '%Eduarda Melo%' THEN 'Eduarda Melo'
      ...
      WHEN ${ad_name} LIKE '%Peewee%'  ${ad_group_name} LIKE '%Peewee%' THEN 'Peewee'
